...
public:
    ...
    void DrawLightning(QVector3D PT_A, QVector3D COLOR_A, QVector3D PT_B, QVector3D COLOR_B, float displace, QOpenGLShaderProgram *program); // Méthode récursive de création de l'arc
};
